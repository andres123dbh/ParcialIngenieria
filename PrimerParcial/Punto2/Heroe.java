public abstract class Heroe {
    ...
    public Heroe (String nombre,String genero,int imagen,String[] habilidades,int vida,int inteligencia,int fuerza,int agilidad,int aguante,int benevolencia,int malevolencia){
        this.nombre = nombre;
        this.genero = genero;
        this.imagen = imagen;
