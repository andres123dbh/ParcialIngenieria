public abstract class Monstruo {
    ...
    public Monstruo(String nombre, String genero, int imagen, String[] habilidades, int vida, int inteligencia, int fuerza, int agilidad, int aguante, int benevolencia, int malevolencia) {
        this.nombre = nombre;
        this.genero = genero;
        this.imagen = imagen;
    ...
    public abstract Monstruo clone();
