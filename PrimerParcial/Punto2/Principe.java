public abstract class Principe {
    ...
    public Principe(String nombre, String genero, int imagen, String[] habilidades, int vida, int inteligencia, int fuerza, int agilidad, int aguante, int benevolencia, int malevolencia) {
        this.nombre = nombre;
        this.genero = genero;
        this.imagen = imagen;
    ...
    public abstract Principe clone();
